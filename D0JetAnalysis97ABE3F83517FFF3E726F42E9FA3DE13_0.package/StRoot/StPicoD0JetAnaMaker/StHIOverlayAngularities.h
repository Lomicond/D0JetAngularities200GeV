...
public:
  ...
  virtual void setICSSubtractionParams(const std::vector<Double_t>& maxDistances, const std::vector<Double_t>& alphas) {
  ...
  pair<TVector3, TVector3> fMcRecoD0Information[kMaxNumberOfD0Events]; // Pion momenta, Kaon momenta
  ...
  StJet *fICS_RecoJet[kMaxNumberOfD0Events];
  ...
  StJetTreeStruct fICS_RecoJetTree;
  ...
  StFJWrapper *ICS_fjw; //! fastjet wrapper
  StFJWrapper *_fjw; //! fastjet wrapper
