//------------------------------------------------------------------------------
// $Id: StRefMultCorr.cxx,v 1.1 2025/01/30 02:06:29 droy1 Exp $
// $Log: StRefMultCorr.cxx,v $
// Revision 1.1  2025/01/30 02:06:29  droy1
// Initial Commit
//
// Revision 1.1  2025/01/30 00:43:28  droy1
// Initial Commit
//
...
// --- DEBUG BLOK: deterministický seed z (RefMult, z, zdcRate) ---
// (dočasně, jen na kontrolu, pak smazat!)

// převedeme zVtx a zdcRate na rozumná celá čísla
Int_t iRef  = (Int_t)RefMult;
Int_t iVz   = TMath::Nint(z * 1000.0);            // např. 3.973767 -> 3974
Int_t iZdc  = TMath::Nint(zdcCoincidenceRate);    // ZDC rate zaokrouhlený na celé číslo

// jednoduché promíchání do jednoho seedu
UInt_t seed = 14699u;
seed = seed * 1000003u + (UInt_t)iRef;
seed = seed * 1000003u + (UInt_t)(iVz & 0xFFFF);
seed = seed * 1000003u + (UInt_t)(iZdc & 0xFFFF);

// nastavíme seed pro gRandom
...
/*
    cout << "1_CentBin16: " << CentBin16 << endl;
    cout << "mNCentrality: " << mNCentrality << endl;
    cout << "!isCentralityOk(CentBin16): " << !isCentralityOk(CentBin16) << endl;
    cout << "!isCentralityOk(13): " << !isCentralityOk(13) << endl;
    cout << "!isCentralityOk(14): " << !isCentralityOk(14) << endl;
    cout << "!isCentralityOk(15): " << !isCentralityOk(15) << endl;*/
