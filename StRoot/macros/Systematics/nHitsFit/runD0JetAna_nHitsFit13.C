...
void runD0JetAna_nHitsFit13(string pico="testPico.list",
...
//////
   ...
   /**/picoD0JetAnaMaker->setChargedTracksNHitsFit(13); // nHitsFit >= 
   ...
   /**/picoD0JetAnaMaker->setNHitsFitHadronCorr(13); // nHitsFit >= 
