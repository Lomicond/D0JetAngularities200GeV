...
void runD0JetAna_nHitsFit17(string pico="testPico.list",
...
//////
   ...
   /**/picoD0JetAnaMaker->setChargedTracksNHitsFit(17); // nHitsFit >= 
   ...
   /**/picoD0JetAnaMaker->setNHitsFitHadronCorr(17); // nHitsFit >= 
