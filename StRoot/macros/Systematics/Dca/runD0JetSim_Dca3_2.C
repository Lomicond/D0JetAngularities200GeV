...
void runD0JetSim_Dca3_2(const Char_t *inputFile = "",
                                    ...
                                    const Char_t *outputFile = "output_D0JetSimTest", Int_t nEvents = 20000, bool doTEST = kTRUE, int pYear = 2014) ///Zmenit to v xml!!!!
{
   TString out = outputFile;
    ...
    /**/HIOverlayMaker->SetJetTrackDCAcut(3.2); // <= cm
    ...
    /**/HIOverlayMaker->setMaxDcaZHadronCorr(true, 3.2); // true = dca_z, false = dca; <= [cm]
