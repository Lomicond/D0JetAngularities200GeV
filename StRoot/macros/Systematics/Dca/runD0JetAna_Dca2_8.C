...
void runD0JetAna_Dca2_8(string pico="testPico.list",
...
//////
   ...
   /**/picoD0JetAnaMaker->setChargedTracksDCA(2.8); // abs(DCA) < [cm]
   ...
   picoD0JetAnaMaker->setMCTowerCalibrEnergy(false);
   ...
   /**/picoD0JetAnaMaker->setMaxDcaZHadronCorr(true, 2.8); // true = dca_z, false = dca; <= [cm]
   ...
   picoD0JetAnaMaker->setPeriphOccupancyFactor(true); //Occupancy factor for rho (only 40-80%)
