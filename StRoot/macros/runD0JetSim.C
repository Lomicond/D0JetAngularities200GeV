...
void runD0JetSim(const Char_t *inputFile = "",
                                    ...
                                    const Char_t *outputFile = "output_D0JetSimTest", Int_t nEvents = 2000, bool doTEST = kTRUE, int pYear = 2014) ///Zmenit to v xml!!!!
{
   TString out = outputFile;
    ...
    /////HIOverlayMaker->SetHadrCorrTrackDCAZcut(3.0); // <= cm //OLD
