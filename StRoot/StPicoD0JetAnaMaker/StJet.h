...
public:
  ...
  Double_t GetActualShapeL10half() const {return fJetShapeCorrL10half;}
  Double_t GetActualShapeL11() const {return fJetShapeCorrL11;}
  Double_t GetActualShapeL11half() const {return fJetShapeCorrL11half;}
  Double_t GetActualShapeL12() const {return fJetShapeCorrL12;}  
  Double_t GetActualShapeL13() const {return fJetShapeCorrL13;}
  Double_t GetActualShapeDisp() const {return fJetShapeCorrDisp;}
        
  Double_t JetShapeCorrAng() const {return fJetShapeCorrAng;}
  const fastjet::PseudoJet& GetArea4Vector() const { return fArea4Vec; }
  void SetArea4Vector(const fastjet::PseudoJet& areaVec) { fArea4Vec = areaVec; }
 ...
 // Double_t GetXi(const StVParticle *trk) const;
  ...
  Double_t GetAngularityLambda(const Double_t &kappa, const Double_t &alpha, const Double_t &jetRadius) const;
  Int_t GenNumberOfCons(const bool ghosts, const bool smallPtCut) const;
  Int_t GenNumberOfMCCons(const bool smallPtCut) const;
  Double_t GetJetRho() const;
  Double_t GetJetRhoM() const;

  void GetMomentumOfConst(TH2D* hMcJetConstMom) const;
  void GetThetaOfConst(TH2D* hMcJetConstTheta) const;
  Double_t GetShapeCorrAngular() const;
  ...
  void SetJetShapeCorrL10half(Double_t hodnota) {fJetShapeCorrL10half = hodnota;}
  void SetJetShapeCorrL11(Double_t hodnota) {fJetShapeCorrL11 = hodnota;}
  void SetJetShapeCorrL11half(Double_t hodnota) {fJetShapeCorrL11half = hodnota;}
  void SetJetShapeCorrL12(Double_t hodnota) {fJetShapeCorrL12 = hodnota;}
  void SetJetShapeCorrL13(Double_t hodnota) {fJetShapeCorrL13 = hodnota;}
  void SetJetShapeCorrDisp(Double_t hodnota) {fJetShapeCorrDisp = hodnota;}
  void SetJetRho(Double_t JetRho) { fJetRho = JetRho; }
  void SetJetRhoM(Double_t JetRhoM) { fJetRhoM = JetRhoM; }
...
protected:
  ...
  Double_t fJetShapeCorrAng;
  Double_t fJetShapeCorrL10half;
  Double_t fJetShapeCorrL11;
  Double_t fJetShapeCorrL11half;
  Double_t fJetShapeCorrL12;
  Double_t fJetShapeCorrL13;
  Double_t fJetShapeCorrDisp;
  Double_t fJetRho;
  Double_t fJetRhoM;
  fastjet::PseudoJet fArea4Vec;
